...
| * v * t * e Administrative divisions of Monaco | | |
| --- | --- | --- |
| Traditional *Quartiers* 1 | * Monaco-Ville * La Condamine * Monte Carlo * Fontvieille |  |
| Reserved Sectors | * Monaco-Ville * Ravin de Sainte-Dévote |
| Wards | * La Condamine * Fontvieille * Jardin Exotique * Larvotto * Les Moneghetti * Monte Carlo * La Rousse * Le Portier |
| * 1 ordered by age of foundation | | |
...
| States with limitedrecognition | * Abkhazia * Kosovo * Northern Cyprus * South Ossetia * Transnistria |
