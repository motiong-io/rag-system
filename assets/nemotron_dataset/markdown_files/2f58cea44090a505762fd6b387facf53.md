...
| --- | --- | --- |
| A | * Apollo 4 * Apollo 6 | Uncrewed flights of launch vehicles and the CSM, to demonstrate its design and to certify its safety for humans.\[a] |
...
| E | — | Crewed flight demonstration of CSM and LM in medium Earth orbit, performing the maneuvers involved in a lunar landing. |
...
| H | * Apollo 12 * Apollo 13 (planned) * Apollo 14 | Precision crewed lunar landing demonstration and systematic lunar exploration.: 466 |
| I | — | Reserved for lunar survey missions. (Not used) |
| J | * Apollo 15 * Apollo 16 * Apollo 17 | Extended scientific investigation of the Moon on the lunar surface and from lunar orbit.: 466 |
