...
def test_reactor(question:str):
    ...
    llm_answer = llm.full_response(conversation, sys_prompt="You are an intelligent assistant specialized in solving questions. Try to answer the user's question briefly",temperature=0)
    return llm_answer
